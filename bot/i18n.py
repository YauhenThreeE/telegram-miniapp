...
translations: dict[str, dict[str, str]] = {
    "en": {
        ...
        "btn_recipes": "My recipes",
        "btn_ask": "Ask dietitian (stub)",
        "btn_profile": "/profile",
        "recipes_header": "Your recipes (latest {count}):",
        "recipes_empty": "You don't have any saved recipes yet.",
        "recipes_hint": "Tap a recipe to view or delete it.",
        "recipes_add_button": "Add recipe",
        "recipes_back_button": "Back to list",
        "recipes_prompt_title": "Send the recipe name.",
        "recipes_prompt_body": "Send the recipe details: ingredients and steps.",
        "recipes_saved": "Recipe saved.",
        "recipes_deleted": "Recipe deleted.",
        "recipes_not_found": "Recipe not found.",
        "recipes_delete_button": "Delete recipe",
        "recipes_edit_title_button": "Edit title",
        "recipes_edit_body_button": "Edit body",
        "recipes_updated": "Recipe updated.",
        "recipes_ai_button": "Ask AI to draft",
        "recipes_ai_working": "Creating a recipe draft...",
        "recipes_ai_failed": "Could not get a draft from AI. Please type the recipe manually.",
        "recipes_ai_ready": "Here is an AI draft. You can edit and send your own version or tap Save draft.",
        "recipes_ai_use_button": "Save AI draft",
        "sex_m": "Male",
        "sex_f": "Female",
        "sex_other": "Other",
        "activity_low": "Low",
        ...
        "menu_weight": "Weight",
        "menu_stats": "Stats",
        "menu_ask_dietitian": "Ask dietitian",
        ...
        "stats_reset_done": "Today's meals and water stats have been cleared.",
        "stats_reset_error": "Could not reset stats. Please try again later.",
        "stats_reset_all_done": "All your meals, water, and weight logs have been cleared.",
        "stats_reset_all_error": "Could not reset all stats. Please try again later.",
        ...
        "ask_dietitian_intro": "You can ask a question about your diet, digestion, symptoms, or your logs. I will answer as an AI nutrition assistant.",
        ...
        "help_text": (
            ...
            "- show daily stats\n"
            "- save your own recipes (/recipes)\n"
            "- reset stats (/reset_stats) or all logs (/reset_all)\n"
    ...
    "ru": {
        ...
        "btn_recipes": "Мои рецепты",
        "btn_ask": "Спросить диетолога (заглушка)",
        "btn_profile": "/profile",
        "recipes_header": "Ваши рецепты (последние {count}):",
        "recipes_empty": "У вас пока нет сохранённых рецептов.",
        "recipes_hint": "Нажмите на рецепт, чтобы открыть или удалить.",
        "recipes_add_button": "Добавить рецепт",
        "recipes_back_button": "Назад к списку",
        "recipes_prompt_title": "Отправьте название рецепта.",
        "recipes_prompt_body": "Отправьте описание рецепта: ингредиенты и шаги.",
        "recipes_saved": "Рецепт сохранён.",
        "recipes_deleted": "Рецепт удалён.",
        "recipes_not_found": "Рецепт не найден.",
        "recipes_delete_button": "Удалить рецепт",
        "recipes_edit_title_button": "Изменить название",
        "recipes_edit_body_button": "Изменить описание",
        "recipes_updated": "Рецепт обновлён.",
        "recipes_ai_button": "Попросить ИИ набросать",
        "recipes_ai_working": "Создаю черновик рецепта...",
        "recipes_ai_failed": "Не удалось получить черновик от ИИ. Введите рецепт вручную.",
        "recipes_ai_ready": "Черновик от ИИ. Можете отредактировать и отправить или нажать Сохранить черновик.",
        "recipes_ai_use_button": "Сохранить черновик",
        "sex_m": "Мужской",
        "sex_f": "Женский",
        "sex_other": "Другое",
        "activity_low": "Низкий",
        ...
        "menu_ask_dietitian": "Спросить диетолога",
        ...
        "stats_reset_done": "Статистика за сегодня (еда и вода) очищена.",
        "stats_reset_error": "Не удалось сбросить статистику. Попробуйте позже.",
        "stats_reset_all_done": "Все записи еды, воды и веса очищены.",
        "stats_reset_all_error": "Не удалось сбросить все данные. Попробуйте позже.",
        ...
        "ask_dietitian_intro": "Вы можете задать вопрос о питании, желудке, симптомах или ваших записях. Я отвечу как ИИ-помощник по питанию.",
        ...
        "help_text": (
            ...
            "- сохранять свои рецепты (/recipes)\n"
            "- очищать статистику (/reset_stats) или все логи (/reset_all)\n"
            ...
            "/reset_stats - очистить сегодняшние записи еды и воды\n"
            "/reset_all - удалить все записи еды, воды и веса\n"
    ...
    "pl": {
        ...
        "btn_recipes": "Moje przepisy",
        "btn_ask": "Zapytaj dietetyka (stub)",
        "btn_profile": "/profile",
        "recipes_header": "Twoje przepisy (ostatnie {count}):",
        "recipes_empty": "Nie masz jeszcze zapisanych przepisów.",
        "recipes_hint": "Dotknij przepisu, aby otworzyć lub usunąć.",
        "recipes_add_button": "Dodaj przepis",
        "recipes_back_button": "Wróć do listy",
        "recipes_prompt_title": "Wyślij nazwę przepisu.",
        "recipes_prompt_body": "Wyślij opis przepisu: składniki i kroki.",
        "recipes_saved": "Przepis zapisany.",
        "recipes_deleted": "Przepis usunięty.",
        "recipes_not_found": "Nie znaleziono przepisu.",
        "recipes_delete_button": "Usuń przepis",
        "recipes_edit_title_button": "Edytuj nazwę",
        "recipes_edit_body_button": "Edytuj opis",
        "recipes_updated": "Przepis zaktualizowany.",
        "recipes_ai_button": "Poproś AI o szkic",
        "recipes_ai_working": "Tworzę szkic przepisu...",
        "recipes_ai_failed": "Nie udało się dostać szkicu od AI. Wpisz przepis ręcznie.",
        "recipes_ai_ready": "Szkic od AI. Możesz go poprawić i wysłać albo kliknąć Zapisz szkic.",
        "recipes_ai_use_button": "Zapisz szkic AI",
        "sex_m": "Mężczyzna",
        "sex_f": "Kobieta",
        "sex_other": "Inne",
        "activity_low": "Niski",
        ...
        "menu_ask_dietitian": "Zapytaj dietetyka",
        ...
        "ask_dietitian_intro": "Możesz zadać pytanie o dietę, trawienie, objawy albo swoje logi. Odpowiem jako asystent żywieniowy AI.",
        ...
        "help_text": (
            ...
            "- zapisywać własne przepisy (/recipes)\n"
